...
public class Util
{
    public static ResourceLocation getDimensionResLoc(Level world)
    {
    ...
    public static boolean swapItems(Player player, int a, int b)
    {
        {
    ...
    public static boolean unequipItem(Player player, int a)
    {
